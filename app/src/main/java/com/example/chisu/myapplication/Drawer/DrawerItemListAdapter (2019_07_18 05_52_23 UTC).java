...
public class DrawerItemListAdapter extends BaseAdapter {
    ...
    private ArrayList<DrawerListItem> drawerListItems = new ArrayList<>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.drawerListImageView) ;
        TextView titleTextView = (TextView) convertView.findViewById(R.id.drawerListTextView) ;

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        DrawerListItem listViewItem = drawerListItems.get(position);

        // 아이템 내 각 위젯에 데이터 반영. 여기서 드로어블이 아닌 내부 리소스를 쓴다.
