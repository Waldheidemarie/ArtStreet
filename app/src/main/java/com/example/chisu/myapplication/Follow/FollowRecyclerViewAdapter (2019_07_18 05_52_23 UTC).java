...
public class FollowRecyclerViewAdapter extends RecyclerView.Adapter<FollowRecyclerViewAdapter.ViewHolder> {
    ...
    //아이템 리스트 정의
    private List<FollowRecyclerviewItem> followItemList;

    //Glide의 erro, placeholder 옵션을 위한 requestoption 선언 및 초기화
    RequestOptions requestOptions = new RequestOptions();

    //어댑터의 생성자 정의
    public FollowRecyclerViewAdapter(List<FollowRecyclerviewItem> List, Context context1){
        super();
    ...
    public FollowRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.follow_recyclerview_item_layout, parent, false);

        FollowRecyclerViewAdapter.ViewHolder viewHolder = new FollowRecyclerViewAdapter.ViewHolder(v);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(FollowRecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        //리스트의 아이템 생성.
        final FollowRecyclerviewItem item =  followItemList.get(position);
        ...
        holder.followViewUser.setText(item.getUsername());
...
//            }
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public com.github.siyamed.shapeimageview.CircularImageView followUserImage;
        public TextView followViewUser;

        //Initializing Views
        public ViewHolder(View itemView) {
            super(itemView);
            followUserImage = itemView.findViewById(R.id.followUserImage);
            followViewUser = itemView.findViewById(R.id.followUserName);
