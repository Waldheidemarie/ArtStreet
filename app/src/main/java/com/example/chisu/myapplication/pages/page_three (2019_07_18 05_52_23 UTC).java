 ...
 */
public class page_three extends Fragment implements RecyclerView.OnScrollChangeListener{
    ...
    public static page_three newInstance(){
        ...
        page_three fragment = new page_three();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_page_3, container, false);
...
//        adapter = new MainRecyclerViewAdapter(artList, activity);
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        final ProgressBar progressBar = v.findViewById(R.id.progressBar3);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLs.FEED + "?apicall=third&page=" + String.valueOf(requestCount),
