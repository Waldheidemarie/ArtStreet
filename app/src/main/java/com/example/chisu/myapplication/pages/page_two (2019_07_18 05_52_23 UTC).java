 ...
 */
public class page_two extends Fragment implements RecyclerView.OnScrollChangeListener{
    ...
    public static page_two newInstance(){
        ...
        page_two fragment = new page_two();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_page_2, container, false);
...
//        adapter = new MainRecyclerViewAdapter(artList, activity);
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLs.FEED + "?apicall=second&page=" + String.valueOf(requestCount),
