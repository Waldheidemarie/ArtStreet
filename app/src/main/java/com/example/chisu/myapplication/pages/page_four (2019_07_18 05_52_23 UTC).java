 ...
 */
public class page_four extends Fragment implements RecyclerView.OnScrollChangeListener{
    ...
    public static page_four newInstance(){
        ...
        page_four fragment = new page_four();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_page_4, container, false);
...
//        adapter = new MainRecyclerViewAdapter(artList, activity);
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        final ProgressBar progressBar = v.findViewById(R.id.progressBar4);
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLs.FEED + "?apicall=forth&page=" + String.valueOf(requestCount),
